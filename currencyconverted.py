...
def currency_converter(currency_from, currency_to, currency_input):
    ...
    try:
        ...
        print(str(e))
currency_input = 1
currenc_codes : http://en.wikipedia.org/wiki/ISO_4217
currency_from = "USD"
currency_to = "TRY"
...
#you have to input the value you need to convert and then you can have the output
#Code made with Love by Dila_Wa